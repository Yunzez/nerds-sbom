CREATE USER created_instances_user WITH PASSWORD 'Z1a7bOFfFkvVuGh9Xt18J0XFbIhxTilg';
CREATE USER insert_user WITH PASSWORD 'zdAA413FFOBgtCGTUhvN9Y9jFnacUu20';
CREATE USER read_only_user WITH PASSWORD 'EbXgIshUZrdfURDTwpZ63ZMIjO9jOmRq';
